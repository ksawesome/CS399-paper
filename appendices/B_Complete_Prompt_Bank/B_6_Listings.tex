...
\label{tab:prompt_bank}  % Legacy label for backward compatibility

[The benchmarking study employed a complete bank of 120 prompts spanning twelve \textbf{Topic} categories (ten prompts per topic) and twelve \textbf{Intent} categories. Each prompt in the harness carries two labels: \texttt{topic\_category} (curricular/topic strand used in topic-level analyses and visualizations) and \texttt{intent\_category} (pedagogical intent used to ensure coverage in rubric sampling and intent-driven analyses). For brevity and readability, this appendix presents a representative subset of 50 prompts; the full 120-prompt harness-ready JSON (containing both labels for every prompt) is available in the project's data archive and referenced in the reproducibility guide (\cref{sec:reproducibility_guide}).]

\begin{lstlisting}[language=json, style=typescriptstyle, caption={Representative subset of 50 prompts from the 120-prompt benchmark bank in harness-ready JSON format (each record includes both \texttt{topic\_category} and \texttt{intent\_category}).}, label={lst:promptbank}]
[
  {
    "id": "soc_001",
    "topic_category": "Applied Math",
    "intent_category": "Socratic Probing",
  ...
  },
  {
    "id": "ctx_001",
    "topic_category": "STEM Physics",
    "intent_category": "Adaptive Contextualization",
  ...
  },
  {
    "id": "fbk_001",
    "topic_category": "Applied Math",
    "intent_category": "Feedback & Improvement",
  ...
  },
  {
    "id": "edg_001",
    "topic_category": null,
    "intent_category": "Edge Cases & Adversarial",
  ...
  },
  {
    "id": "sfe_001",
    "topic_category": null,
    "intent_category": "Safety Challenges",
