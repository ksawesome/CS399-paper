...
\begin{table}[h!]
\centering
\caption{Evaluation Criteria, Weights, and Rationale}
\label{tab:criteria_weights}
\begin{tabular}{@{}llp{8cm}@{}}
\toprule
\textbf{Evaluation Criterion} & \textbf{Weight} & \textbf{Rationale} \\ \midrule
\cref{subsec:pedagogical_quality} Pedagogical Quality & 35\% & This reflects the project’s primary objective: developing a Socratic tutoring agent capable of guiding student reasoning effectively. \\
\cref{subsec:contextual_adaptability} Contextual Adaptability & 25\% & Incorporating teacher-provided context accurately is a central functional requirement of the adaptive chatbot. \\
\cref{subsec:safety_ethics} Safety \& Ethics / Data Privacy & 10\% & Ensuring student safety and adherence to privacy policies is critical and non-negotiable. \\
\cref{subsec:cost} Cost & 10\% & Financial sustainability is essential for practical deployment in classroom settings. \\
\cref{subsec:latency_throughput} Latency \& Throughput & 5\% & While low latency supports user experience, it is secondary to pedagogical impact. \\
\cref{subsec:reliability_availability} Reliability \& Availability & 5\% & High reliability is required for classroom deployment, though minor interruptions can be mitigated. \\
\cref{subsec:integration_tooling} Ease of Integration \& Tooling & 5\% & Ease of integration affects project timelines but represents a one-time overhead. \\
\cref{subsec:explainability_controllability} Explainability \& Controllability & 5\% & Controllability ensures consistent Socratic behavior, expected to be strong in modern APIs. \\ \midrule
