...
\begin{enumerate}
    ...
    \item \textbf{Human Fidelity Score:} Trained evaluators rated each response on a five-point scale, assessing how accurately and appropriately the context was applied (see \cref{sec:scoring_rubrics} and \cref{app:context_fidelity_rubric}). This measured both the inclusion of context and its correct usage.
